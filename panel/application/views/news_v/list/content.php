<div class="row">
    <div class="col-md-12">
		<h4 class="m-b-lg">
            News List
            <a href="<?php echo base_url("news/new_form") ?>" class="btn btn-outline btn-primary btn-xs pull-right"><i class="fa fa-plus"> New news</i></a>
        </h4>
	</div><!-- END column -->
    <div class="col-md-12">
                ...
                <tbody class="sortable" data-url="<?php echo base_url("news/rankSetter"); ?>">
                    ...
                    <tr id="ord-<?php echo $item->id; ?>">
                        ...
                        <td class="process-center">
                            ...
                            <a href="<?php echo base_url("news/update_form/$item->id"); ?>" class="btn btn-xs btn-info btn-outline" title="edit"><i class="fa fa-pencil-square-o"></i> Edit</a>
                        </td>
                    </tr>
                    <?php } ?>
